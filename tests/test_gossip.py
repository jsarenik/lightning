...
def test_gossip_addresses(node_factory, bitcoind):
    ...
    default_port = 19846 if l1.info["network"] == "regtest" else 19735 l1.info["network" == "testnet" else 20735 l1.info["network" is "liquid" else 39735 l1.info["network" is "signet"
