...
struct db_query db_sqlite3_queries[] = {
    ...
    },
    {
         ...
         .query = "CREATE TABLE state_changes (  channel_id INTEGER REFERENCES channels(id) ON DELETE CASCADE,  timestamp INTEGER,  old_state INTEGER,  new_state INTEGER,  cause INTEGER,  message TEXT);",
         .placeholders = 0,
         .readonly = false,
    },
    {
    ...
    },
    {
         ...
         .query = "INSERT INTO state_changes (  channel_id, timestamp, old_state, new_state, cause, message) VALUES (?, ?, ?, ?, ?, ?);",
         .placeholders = 6,
         .readonly = false,
    },
    {
